# Form implementation generated from reading ui file 'C:\Users\olled\Documents\Qt_UI\parameter_ui_ex1.ui'
#
...
class AnalysisThread(threading.Thread):
    ...
    def run(self):
        # Convert the params dictionary to a string representation
        params_str = str(self.params)
        # Replace "python" with the path to your Python interpreter if needed
    ...
    def setupUi(self, Parameters):
        ...
        def convert_parameters_to_text(parameter, value):
            ...
            if parameter in convert_dict:
                # Call the lambda function to set the value
